...
public class paraBankAccOverView {
...
//		driver.quit();
		...
		public void transfer_has_been_completed() throws InterruptedException {
			...
			public void user_will_click_on_account_activity() {
				
				System.out.println("Click on ccount Activity");
				driver.findElement(By.xpath("//a[text()='Accounts Overview']")).click();

			}
			@When("User will Click on Account")
			public void user_will_click_on_account()  throws InterruptedException {
				System.out.println("Click on Account");
				driver.findElement(By.xpath("//a[text()='14898']")).click();
				Thread.sleep(2000);
			}
//			@And("User will select the Avtivity Period")
//			public void user_will_select_the_avtivity_period() {
//				System.out.println("select the Avtivity Period");
//				//driver.findElement(By.xpath("//select[@id='month']")).click();
//				WebElement dropdown=driver.findElement(By.id("month"));
//				//dropdown.selectByVisibleText("August");
//				Select selectObject=new Select(dropdown);
//				selectObject.selectByVisibleText("August");
				//dropdown.selectByIndex(8);
//				driver.findElement(By.xpath("//select[@id='month']")).click();
//				driver.findElement(By.xpath("//Select//option[@value='August']")).click();

//			}
			
			@When("select the Avtivity Period")
			public void select_the_avtivity_period() {
				System.out.println("select the Avtivity Period");
				WebElement dropdown=driver.findElement(By.id("month"));
				Select selectObject=new Select(dropdown);
				selectObject.selectByVisibleText("August");
			...
			public void user_will_select_type() {
				System.out.println("select Type");
				//driver.findElement(By.xpath("//select[@id='transactionType']")).click();
				//Select dropdown1=new Select(driver.findElement(By.id("transactionType")));
				
				WebElement dropdown1=driver.findElement(By.id("transactionType"));
				Select selectObject1=new Select(dropdown1);
				selectObject1.selectByVisibleText("Credit");
				
				//se.selectByIndex(1);
//				driver.findElement(By.xpath("//select[@id='transactionType']")).click();
//				driver.findElement(By.xpath("//Select//option[@value='Credit']")).click();


			}

			@And("User will Click on GO")
			public void user_will_click_on_go() throws InterruptedException {
			...
			public void transfer_fund_will_show() {
				System.out.println("Transfer Fund will show");
				driver.findElement(By.xpath("//table[@id='transactionTable']"));
				driver.close();
				driver.quit();
			}	
